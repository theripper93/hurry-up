...
export class HTMLAlphaColorPickerElement extends foundry.applications.elements.AbstractFormInputElement {
     ...
     */
    constructor({value, step, min, max, label} = {}) {
        super();
        ...
        this._label = label || this.getAttribute("label") || "";
    }
    ...
    _buildElements() {
        ...
        label.style.flex = "1";
        if(!this._label) label.style.display = "none";
        ...
        innerContainer.appendChild(this.#colorPicker);
        innerContainer.appendChild(this.#colorAlpha);
        innerContainer.appendChild(this.#colorOutput);
